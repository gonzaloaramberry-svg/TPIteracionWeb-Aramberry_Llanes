...
GameManager.prototype.actuate = function () {
  if (this.storageManager.getBestScore() < this.score) {
    ...
    this.statsmanager.registrarEvento("puntaje", this.score);
  }
...
GameManager.prototype.move = function (direction) {
    ...
    traversals.y.forEach(function (y) {
      ...
      if (tile) {
        ...
        if (next && next.value === tile.value && !next.mergedFrom) {
          self.statsmanager.registrarEvento("combinacion");
          ...
          if (merged.value === 2048 && !self.won)  {
            self.won = true;
            self.statsmanager.registrarEvento("victoria");
          }
        } else {
  ...
  if (moved) {
    this.statsmanager.registrarEvento("movimiento");
    this.addRandomTile();

    if (!this.movesAvailable()) {
      this.over = true; // Game over!
      this.statsmanager.registrarEvento("derrota");
    }
